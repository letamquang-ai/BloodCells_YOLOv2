class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('validation', '../pascal/VOCdevkit/IMG/', 'path to validation directory')
        ...
        self.define('annotation_valid', '../pascal/VOCdevkit/ANN/', 'path to validation annotation directory')
